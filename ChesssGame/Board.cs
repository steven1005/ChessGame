...
namespace ChesssGame
{
    public class Board
    {
        ...
        public List<HalfBoardStatus> rectHalfBoard = new List<HalfBoardStatus>() {
            ...
            new HalfBoardStatus{ rect = new Rectangle { Location = new Point(418, 55), Size = Piece.sPieceIcon}, iPlayer = -1, iPieceIdx = -1},
            new HalfBoardStatus{ rect = new Rectangle { Location = new Point(498, 55), Size = Piece.sPieceIcon}, iPlayer = -1, iPieceIdx = -1},
            ...
            new HalfBoardStatus{ rect = new Rectangle { Location = new Point(418, 135), Size = Piece.sPieceIcon}, iPlayer = -1, iPieceIdx = -1},
            new HalfBoardStatus{ rect = new Rectangle { Location = new Point(498, 135), Size = Piece.sPieceIcon}, iPlayer = -1, iPieceIdx = -1},
            ...
            new HalfBoardStatus{ rect = new Rectangle { Location = new Point(418, 218), Size = Piece.sPieceIcon}, iPlayer = -1, iPieceIdx = -1},
            new HalfBoardStatus{ rect = new Rectangle { Location = new Point(498, 218), Size = Piece.sPieceIcon}, iPlayer = -1, iPieceIdx = -1},
            ...
            new HalfBoardStatus{ rect = new Rectangle { Location = new Point(418, 300), Size = Piece.sPieceIcon}, iPlayer = -1, iPieceIdx = -1},
            new HalfBoardStatus{ rect = new Rectangle { Location = new Point(498, 300), Size = Piece.sPieceIcon}, iPlayer = -1, iPieceIdx = -1},
            new HalfBoardStatus{ rect = new Rectangle { Location = new Point(578, 300), Size = Piece.sPieceIcon}, iPlayer = -1, iPieceIdx = -1},
            new HalfBoardStatus{ rect = new Rectangle { Location = new Point(658, 300), Size = Piece.sPieceIcon}, iPlayer = -1, iPieceIdx = -1},
        };
    }
}
